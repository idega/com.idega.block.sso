...
public class TicketServiceServiceLocator extends org.apache.axis.client.Service implements com.idega.block.sso.webservice.server.ticketService.TicketServiceService {
    ...
    public com.idega.block.sso.webservice.server.ticketService.TicketService getTicketService() throws javax.xml.rpc.ServiceException {
    ...
    public com.idega.block.sso.webservice.server.ticketService.TicketService getTicketService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.idega.block.sso.webservice.server.ticketService.TicketServiceSoapBindingStub _stub = new com.idega.block.sso.webservice.server.ticketService.TicketServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.idega.block.sso.webservice.server.ticketService.TicketService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.idega.block.sso.webservice.server.ticketService.TicketServiceSoapBindingStub _stub = new com.idega.block.sso.webservice.server.ticketService.TicketServiceSoapBindingStub(new java.net.URL(this.TicketService_address), this);
                _stub.setPortName(getTicketServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:com.idega.block.sso.webservice", "TicketServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (this.ports == null) {
            ...
            this.ports.add(new javax.xml.namespace.QName("urn:com.idega.block.sso.webservice", "TicketService"));
        }
